...
openAT(){
   ...
   /*  let json = {activity_description : this.text,
    ...
    this.http.post('http://qpos.msuproject.net/AllNewService/activity/addactivity',JSON.stringify(json)).toPromise().then(data => {
      if(data == 1){
        alert('OK!!');
      }else{
        alert('err');
    ...
    this.router1.navigateByUrl('/addativity/'+this.user_username);
